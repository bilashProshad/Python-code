...
def tableDrivenVaccumAgent():
    table = {
        ...
        ((loc_C, 'Clean'), (loc_C, 'Clean')): random.choice(['Up', 'Right']),

        ((loc_D, 'Clean'), (loc_B, 'Dirty')): 'Suck',
        ((loc_D, 'Clean'), (loc_B, 'Clean')): random.choice(['Down', 'Left']),
        ((loc_D, 'Clean'), (loc_D, 'Dirty')): 'Suck',
        ((loc_D, 'Clean'), (loc_D, 'Clean')): random.choice(['Up', 'Left']),
        ((loc_D, 'Dirty'), (loc_D, 'Dirty')): 'Suck',


        ((loc_C, 'Clean'), (loc_D, 'Clean')): random.choice(['Up', 'Right']),
