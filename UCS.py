...
# uniform cost search
uniformCostSearch = best_first_search(graph_problem, lambda node:node.path_cost)
print("Result:", uniformCostSearch.solution())
print("Path Cost:", uniformCostSearch.path_cost)
